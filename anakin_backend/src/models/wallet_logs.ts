...
@table(makeTableName(DB_CONFIG.TABLES.WALLET_LOGS))
export default class WALLET_LOGS extends GlobalSecondaryIndex {
  ...
  public static async addIntoWalletLogs(user_wallet_address: string, balance_change: number, group: string, message: string) {
    await mapper.put(
      Object.assign(new WALLET_LOGS(), {
        user_wallet_address,
        balance_change,
        group,
        message
