...
//     await presaleV2.connect(secondAddressSigner).mintPreSaleBitfighterCard("abcd", addresses[18].address)
//     await presaleV2.connect(secondAddressSigner).mintPreSaleBitfighterCard("abcde", addresses[18].address)
